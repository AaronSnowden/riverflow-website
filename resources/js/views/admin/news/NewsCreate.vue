  ...
  <div>
    ...
    <div class="mb-8">
      <div class="flex items-center mb-4">
        ...
        <h1 class="text-3xl font-bold text-neutral-900">Create News Article</h1>
      </div>
      <p class="text-neutral-600">Fill in the details to create a new news article</p>
    </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Failed to create article. Please try again.'
  } finally {
