        ...
        <form @submit.prevent="handleSubmit" class="w-full">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            required
                            placeholder="e.g., Annual Teacher Training Workshop"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-neutral-500 mt-1">
                            This will be used in the event URL. Use lowercase
                            letters and hyphens.
                        </p>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            required
                            placeholder="e.g., Kenyatta International Convention Centre, Nairobi, Kenya"
                            class="w-full px-4 py-2 border border-neutral-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary"
                        />
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input
                            ...
                            type="text"
                            required
                            placeholder="e.g., Free for STIA members, $50 for non-members"
                            class="w-full px-4 py-2 border border-neutral-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary"
                        />
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg border border-neutral-200 p-6 mb-6">
                ...
                <div
                    ...
                    class="text-sm text-neutral-500 text-center py-4"
                >
                    No agenda items added yet. Click "Add Item" to add one.
                </div>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        const eventData = {
            ...
            fee: form.value.fee,
            speakers: form.value.speakers.filter((s) => s.trim() !== ""), // Remove empty speakers
            agenda: form.value.agenda.filter((a) => a.trim() !== ""), // Remove empty agenda items
            status: "published", // Set initial status as draft
            state: "active", // Set initial state as active
        };

        // Call the store action to create the event
